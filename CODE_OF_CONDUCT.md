...
reported to the maintainer (@backed-by-data) privately — GitHub's private
vulnerability reporting on this repository reaches the same inbox and works
for conduct reports you'd rather not make in public. All complaints will be
...
2. **Warning** — a warning with consequences for continued behavior,
   including limited interaction with the people involved for a specified
   period.

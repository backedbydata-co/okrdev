...
| [docs/evidence.md](docs/evidence.md) | What counts as proof: the evidence ladder, the demo review, the customer's-words rule, and the partition between this ledger and private state |
